package com.xiaobuzi.jccutilsdamo.carousel;
...
import com.xiaobuzi.jccutilsdamo.mains.HomeFragment;
...
public class CycleViewPager extends FrameLayout
    ...
    private View getImageView(Context context, String url) {
        ...
        return HomeFragment.getImageView(context, url);
    }
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            Log.d("JCC", "instantiateItem: 长度="+mViews.size());
            Log.d("JCC", "instantiateItem: position="+position);
            View v = mViews.get(position);
            Log.d("JCC", "instantiateItem: id="+v.getId());
